...
import { updateSchoolRequest } from '../../../store/modules/school/actions';
...
export default function EditSchoolModal() {
  ...
  const current = useSelector(state => state.school.current);
  ...
  function handleSubmit() {
    if (message === '' || tech === '') {
      ...
      dispatch(updateSchoolRequest(message, attention, tech));
